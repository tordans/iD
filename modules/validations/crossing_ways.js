            ...
            onClick: function(context) {
                ...
                var action = function actionAddStructure(graph) {
                    ...
                    if (crossingType === 'bridge'){
                        ...
                        // we know that the line will already have a side path-type highway value (footway, cycleway, or path)
                        // find which highway value it is and set the corresponding tag to 'crossing'
                        const sidePathTypes = ['footway', 'cycleway', 'path'];
                        const highwayValue = tags.highway;
                        if (highwayValue && sidePathTypes.includes(highwayValue)) {
                            tags[highwayValue] = 'crossing';
                        }
                    }
