...
/**
 * The MapRoulette "robot/target" brand logo as four SVG <path> elements,
 * authored on a 40×40 grid. Kept for non-map chrome that still wants the
 * wordmark; map pins use the V4 status teardrop in `maproulette_marker.ts`.
 */
...
/** @deprecated Use MAPROULETTE_PIN_COLOR from maproulette_marker (V4 cyan). */
export { MAPROULETTE_PIN_COLOR } from './maproulette_marker';

export {
  appendMapRoulettePinIcon,
  type MapRoulettePinIconOptions,
